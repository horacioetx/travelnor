<?php
	...
	if ($numitems == 0) {
		...
		while ($rrowi = $stmt->fetch(PDO::FETCH_ASSOC)) {	
			...
			$delete = '<a data-org="gentxt_extension" data-row-id="' . $rrowi['gt_id'] . '" href="javascript:void(0)" class="btn btn-danger btn-sm delete_data"><i class="fas fa-trash-alt"></i></a>';	
