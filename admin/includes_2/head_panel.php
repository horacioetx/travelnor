		...
		<nav class="nav">
			...
			<div class="dropdown">
				...
				<a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
					<span class="logged-name hidden-md-down"><? echo $_SESSION['member_name']; ?></span>
				...
				<div class="dropdown-menu dropdown-menu-header wd-250">
					...
					<div class="tx-center">
						...
						<h6 class="logged-fullname"><? echo $_SESSION['member_fullname']; ?></h6>
						<p><? echo $_SESSION['member_email']; ?></p>
					</div>
