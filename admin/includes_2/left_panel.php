<?php
	...
	/*** determine active section item in menu ***/
	
	/* Dashboard */
	
	if ((basename($_SERVER['PHP_SELF']) == 'index.php'))
		$active_menu0 = " active show-sub";		
	else	
		$active_menu0 = "";
	...
	if ((basename($_SERVER['PHP_SELF']) == 'mailbox.php'))
		$active_menu1 = " active show-sub";		
	else	
		$active_menu1 = "";

	/* Website CMS menu */
	
	if ((basename($_SERVER['PHP_SELF']) == 'ws_general_settings.php') or (basename($_SERVER['PHP_SELF']) == 'ws_index_settings.php') or (basename($_SERVER['PHP_SELF']) == 'ws_dir_programs.php'))
		$active_menu2 = " active show-sub";		
	else	
		$active_menu2 = "";
...
<div class="br-logo"><a href=""><img src="images/logos/logo2.png"></a></div>
...
<div class="br-sideleft sideleft-scrollbar">
	...
	<ul class="br-sideleft-menu">
		...
		<li class="br-menu-item">
			<a href="index.php" class="br-menu-link <?php echo $active_menu0; ?>">
		...
		<li class="br-menu-item">
			<a href="mailbox.php" class="br-menu-link <?php echo $active_menu1; ?>">
		...
		<li class="br-menu-item">
			<a href="#" class="br-menu-link with-sub <?php echo $active_menu2; ?>">
				<i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
				<span class="menu-item-label">Website CMS</span>
			</a><!-- br-menu-link -->
			<ul class="br-menu-sub">
				<li class="sub-item"><a href="ws_general_settings" class="sub-link <?php if (basename($_SERVER['PHP_SELF']) == 'ws_general_settings.php') echo ' active'; ?>">General Settings</a></li>
				<li class="sub-item"><a href="ws_index_settings" class="sub-link">Index / Home</a></li>
				<li class="sub-item"><a href="ws_dir_programs" class="sub-link <?php if (basename($_SERVER['PHP_SELF']) == 'ws_dir_programs.php') echo ' active'; ?>">Programs Directory</a></li>
			</ul>
		</li>
