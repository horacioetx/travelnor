...
<html lang="en">
	...
	<head>
		...
		<title>Travelnor - Aviso Legal</title>
		...
		<div class="container">			
			...
			<main id="contents">
				...
				<div class="container mt-5 mb-5">		
					...
					<h1 class="text-center mb-4 pt-5 font-italic txt-navy">Aviso Legal</h1>
				
					<?php 
				
						// open config table

						$stmt = $db->query('SELECT web1_legal3 FROM config');
						$legal = $stmt->fetch();

						echo $legal['web1_legal3'];
